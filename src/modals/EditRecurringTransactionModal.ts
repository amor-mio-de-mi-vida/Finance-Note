...
export class EditRecurringTransactionModal extends Modal {
    ...
    constructor(app: App, recurringTransactionService: RecurringTransactionService, recurringTransaction: RecurringTransaction) {
        super(app);
    ...
    onOpen() {
        ...
        this.categoryInput = categoryGroup.createEl('input', {
            ...
            value: this.recurringTransaction.category
        });
        ...
        this.accountInput = accountGroup.createEl('input', {
            ...
            value: this.recurringTransaction.account
        });
